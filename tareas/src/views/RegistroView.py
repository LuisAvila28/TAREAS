...
def RegisterView(page: ft.Page, auth_controller):
    ...
    mensaje = ft.Text("", color=ft.Colors.ORANGE_300, size=12)
    
    def mostrar_snackbar(mensaje_texto, color=ft.Colors.ORANGE_400):
    ...
    def registrar_click(e):
        if not nombre.value or not email.value or not password.value or not confirm_password.value:
            ...
            mensaje.color = ft.Colors.ORANGE_300
            page.update()
            return
        ...
        if exito:
            mostrar_snackbar("¡Registro exitoso! Ahora inicia sesión", ft.Colors.ORANGE_400)
            nombre.value = ""
            apellido.value = ""
            email.value = ""
            password.value = ""
        ...
        controls=[
            ft.Column(
                [
                    ...
                    ft.Text("Registrate", size=20, weight="bold", color=ft.Colors.ORANGE_400),
                    ft.Container(height=10),
